...
outreg2 using "${swdResults}/urban_coefficients.xls", append ctitle("SWIFT-PLUS1") label
...
/*
		...
		* Stepwise 
		...
		estimates store urban2_swift
		outreg2 using "${swdResults}/urban_coefficients.xls", append ctitle("SWIFT-PLUS2") label
		...
		**### save accuracies ----
		...
		local common (ncovariates) ("SWIFT-PLUS") ("2") ("Urban") ("Fixed rate") ("P=0.01") 
		...
		**### save accuracies ----
		...
		local common (ncovariates) ("SWIFT-PLUS") ("2") ("Urban") ("Fixed line") ("P=0.01") 
		...
		* Stepwise 
		...
		reg lpcexp `list3' [aw=hhweight] if milieu == 1, r 
		estimates store urban2_swift
		outreg2 using "${swdResults}/urban_coefficients.xls", append ctitle("SWIFT-PLUS3") label
		...
		**### save accuracies ----
		...
		local common (ncovariates) ("SWIFT-PLUS") ("3") ("Urban") ("Fixed rate") ("P=0.001") 
		...
		**### save accuracies ----
		...
		local common (ncovariates) ("SWIFT-PLUS") ("3") ("Urban") ("Fixed line") ("P=0.001") 
		...
		* Stepwise 
		...
		reg lpcexp `list3' [aw=hhweight] if milieu == 1, r 
		estimates store urban2_swift
		outreg2 using "${swdResults}/urban_coefficients.xls", append ctitle("SWIFT-PLUS4") label
		...
		**### save accuracies ----
		...
		local common (ncovariates) ("SWIFT-PLUS") ("4") ("Urban") ("Fixed rate") ("P=0.0001") 
		...
		**### save accuracies ----
		...
		local common (ncovariates) ("SWIFT-PLUS") ("4") ("Urban") ("Fixed line") ("P=0.0001") 
		...
		* Stepwise 
		...
		reg lpcexp `list3' [aw=hhweight] if milieu == 1, r 
		estimates store urban2_swift
		outreg2 using "${swdResults}/urban_coefficients.xls", append ctitle("SWIFT-PLUS5") label
		...
		**### save accuracies ----
		...
		local common (ncovariates) ("SWIFT-PLUS") ("5") ("Urban") ("Fixed rate") ("P=0.00001") 
		...
		**### save accuracies ----
		...
		local common (ncovariates) ("SWIFT-PLUS") ("5") ("Urban") ("Fixed line") ("P=0.00001") 
...
reg lpcexp `list3' [aw=hhweight] if milieu == 1, r 
estimates store urban2_swift
outreg2 using "${swdResults}/urban_coefficients.xls", append ctitle("SWIFT-PLUS6") label
...
local common (ncovariates) ("SWIFT-PLUS") ("6") ("Urban") ("Fixed rate") ("P=0.000001") 
...
local common (ncovariates) ("SWIFT-PLUS") ("6") ("Urban") ("Fixed line") ("P=0.000001") 
