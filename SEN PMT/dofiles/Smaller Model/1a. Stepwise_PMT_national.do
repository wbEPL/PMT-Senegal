...
capture log close
log using "$log/SEN_PMT_AltModel_Natl.log", replace 

use "$data/data4model_2021_2.dta", clear
cap svyset, clear
*keep if milieu==2 // (milieu: 1=urban, 2=rural) keep all obs for national model 
...
global demo 	region_1 region_3 region_7 dem_logsize dem_emp_rate dem_gender_rate
global house 	/*c_housingocup_**/ c_numberofrooms_c c_roof_* c_floor_* c_walls_* /*c_fuelfirst_* */ c_toilet_* /*c_connectedtoint*/ c_connectedtotv c_connectowater c_connectoelec_* c_fuelfirst_3 c_typehousing_1 /*c_typehousing_2*/ c_typehousing_3 /*c_typehousing_4*/ c_lighting_1 c_lighting_2 c_lighting_3 c_lighting_4 c_lighting_5
...
stepwise, pr(0.00000101) pe(0.000001): reg $lnwelfare $startingvars [pw=$weight]
