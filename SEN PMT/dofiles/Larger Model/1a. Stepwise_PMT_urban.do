...
* Urban Model Creation - larger model						   *
...
capture log close
log using "$log/SEN_PMT_Model_Urban_largemodel.log", replace 
...
stepwise, pr(0.005001) pe(0.0001): reg $lnwelfare $startingvars [pw=$weight]
