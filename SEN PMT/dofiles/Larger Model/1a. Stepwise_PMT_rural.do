...
* Rural Model Creation - larger model						   *
...
capture log close
log using "$log/SEN_PMT_Model_Rural_largemodel.log", replace 
...
stepwise, pr(0.010001) pe(0.0001): reg $lnwelfare $startingvars [pw=$weight]

matrix X = e(b)
matrix X = X[1,1..`e(df_m)']
global xvar: colnames X
fsum $xvar hhsize [aw=$weight], label
