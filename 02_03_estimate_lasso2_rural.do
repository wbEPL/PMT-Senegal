...
outreg2 using "rural_coefficients.xls", append ctitle("Lasso 2-lambda CV") label
...
outreg2 using "rural_coefficients.xls", append ctitle("Lasso 2-lambda 0.02") label
...
outreg2 using "rural_coefficients.xls", append ctitle("Lasso 2-lambda 0.035") label
...
outreg2 using "rural_coefficients.xls", append ctitle("Lasso 2-lambda 0.05") label
